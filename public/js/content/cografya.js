...
export default [
  ...
  // ───────────────────────── 4. GÜN ─────────────────────────
  {
    ...
    cards: [
      {
        ...
        viz: { type: 'table', s: 'cografya', head: ['Tür', 'Nasıl?', 'Örnek'], rows: [
          ...
          ['**Kıyı set (lagün)**', 'Kıyıda kum birikir, deniz parçası ayrılır', '**Köyceğiz**, **Büyük ve Küçük Çekmece**'],
          ['**Alüvyal set**', 'Akarsuyun biriktirdiği alüvyon körfezin/vadinin önünü kapatır', '**Bafa** (Büyük Menderes), **Marmara Gölü** (Gediz)'],
      ...
      },
      {
        ...
        viz: { type: 'map', alt: 'Türkiye gölleri', groups: [], pins: [
          ...
          { lat: 37.5, lon: 27.5, t: 'Bafa (alüvyal set)', c: 'teal' },
          { lat: 37.55, lon: 29.68, t: 'Salda (karstik)', dy: 30, c: 'violet' },
          { lat: 38.0, lon: 30.87, t: 'Eğirdir', c: 'blue' },
        ] },
        note: { h: 'ÖSYM böyle sordu (2020)', t: 'Bafa, Tuz, Tortum ve İznik göllerinden hangileri **tektonik**? → **Tuz ve İznik**. Bafa alüvyal set, Tortum heyelan set.', exam: true },
      },
      {
    ...
    quiz: [
      { q: 'I. Bafa Gölü\nII. Tuz Gölü\nIII. Tortum Gölü\nIV. İznik Gölü\nYukarıdaki göllerden hangileri tektonik hareketler sonucu oluşmuştur?', o: ['I ve II', 'I ve III', 'II ve III', 'II ve IV', 'III ve IV'], a: 3, ex: '**Tuz** ve **İznik** tektonik. Bafa alüvyal set, Tortum heyelan set. (2020 sorusu.)' },
    ...
    flash: [
      ...
      ['Bafa ve Köyceğiz?', 'Bafa **alüvyal set** (Büyük Menderes); Köyceğiz **kıyı set** (lagün)'],
  ...
  // ───────────────────────── 8. GÜN ─────────────────────────
  {
    ...
    cards: [
      {
        ...
        viz: { type: 'table', s: 'cografya', head: ['Tesis', 'Nerede?'], rows: [
          ...
          ['İlk şeker fabrikaları', '**Uşak** ve **Alpullu** (1926)'],
    ...
    flash: [
      ...
      ['İlk şeker fabrikaları?', '**Uşak** ve **Alpullu** (Kırklareli), 1926'],
